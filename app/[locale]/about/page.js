        ...
        <>
            ...
            <nav className={styles.anchorNav} aria-label="About page sections">
                <div>
                    ...
                    <a href="#team">
                        02 — {d.about.foundersTitle} / {d.about.leadershipTitle}
                    </a>
            ...
            <section id="profile" className={styles.section}>
                <div className={styles.split}>
                    <Reveal>
                        <p className="eyebrow">01 · {d.about.title}</p>
                        <h2>{d.brand.name}</h2>
                    </Reveal>
                ...
                <div className={styles.centersGrid}>
                    {d.about.centers.map((center, index) => (
                        <Reveal key={center} delay={(index % 4) * 45}>
                ...
                <div className={styles.darkInner}>
                    ...
                    <Reveal className={styles.darkCopy} delay={90}>
                        ...
                        <div className={styles.principles}>
                            {d.about.principles.map((item, index) => (
                                <span key={item}>
            ...
            <section id="mission" className={styles.missionSection}>
                <div className={styles.sectionInner}>
                    <Reveal>
                        ...
                        <h2>{d.about.missionTitle}</h2>
                    </Reveal>
                    <div className={styles.missionGrid}>
                        {d.about.mission.map((p, index) => (
                            <Reveal key={p} delay={index * 70}>
                                <p className={index === 0 ? styles.missionLead : ""}>{p}</p>
                            </Reveal>
                        ))}
                    </div>
                </div>
            ...
            <section id="vision" className={styles.visionSection}>
                <div className={styles.sectionInner}>
                    ...
                    <Reveal>
                        <LocalizedLink locale={locale} href="/contact?topic=proposal" className={styles.contactLink}>
                            {d.nav.proposal}
                            <span>↗</span>
                        </LocalizedLink>
                    </Reveal>
